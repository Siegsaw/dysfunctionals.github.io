...
echo "</select>";
echo "<div class=\"exp-wrap\">";
echo "<span class=\"exp-label\">Exp</span>";
...
echo "<div class=\"search-filters\">";
    echo "<div class=\"flavor-section\">";
        echo "<label class=\"filter-label\">FLAVOR</label>";
        echo "<div id=\"flavorButtons\" class=\"flavor-btn-group\"></div>";
    echo "</div>";

    echo "<div class=\"sliders-row\">";
        echo "<div class=\"slider-item\">";
            echo "<div class=\"slider-info\">";
                echo "<span>MAX TIME: <strong id=\"timeValue\">45</strong> MIN</span>";
            echo "</div>";
            echo "<input type=\"range\" id=\"timeRange\" min=\"5\" max=\"180\" step=\"5\" value=\"45\" oninput=\"updateTimeValue()\">";
        echo "</div>";

        echo "<div class=\"slider-item\">";
            echo "<div class=\"slider-info\">";
                echo "<span>MAX CALORIES: <strong id=\"calValue\">800</strong> KCAL</span>";
            echo "</div>";
