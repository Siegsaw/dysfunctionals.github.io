...
<div class="page-sub">Assign values per 100g for each ingredient</div>
...
<div class="section">2. Nutrient Values (per 100g)</div>
...
function saveNutrition() {
    ...
    if (missing.length > 0) {
        alert("Required (>0 per 100g): calories, fat, carbs, protein");
        return;
    }
