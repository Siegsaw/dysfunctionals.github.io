...
echo "<div style='font-size:11px; color:var(--muted); margin-bottom:6px;'>
        Servings
      </div>";
...
echo "<input 
        ...
        step='1' 
        value='1'
        placeholder='How many servings the recipe makes'
...
echo "<select 
        ...
        class='input' 
        multiple 
        style='height:140px; margin-bottom:0;'
      >
        $flavors_options
      </select>";
echo "</div>";
...
echo "<button class='btn' type='button' onclick='addIngredientRow()'>
        + Add ingredient
      </button>";
...
echo "<button class='btn' type='button' onclick='addStepRow()'>
        + Add step
      </button>";
...
echo "<button class='btn' type='button' onclick='previewRecipe()'>
        Preview Recipe
      </button>";
